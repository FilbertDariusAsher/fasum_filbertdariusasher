...
Future<void> showNotificationFromData(Map<String, dynamic> data) async {
  ...
  // Menentukan style berdasarkan ketersediaan gambar gambar
  final styleInformation = largeIconBitmap != null
  ...
  final androidDetails = AndroidNotificationDetails(
    ...
    styleInformation:
        styleInformation, // Menggunakan styleInformation yang benar
    largeIcon: largeIconBitmap,
